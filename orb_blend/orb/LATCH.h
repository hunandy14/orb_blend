...
struct KeyPoint {
	...
	// angle in RADIANS
	KeyPoint(float _x, float _y, float _scale, float _angle): 
		x(_x), y(_y), scale(_scale), angle(_angle) {}
	KeyPoint() : x(0), y(0), scale(0), angle(-1) {}
};
...
void _LATCH(
	...
	const uint8_t* const __restrict image, 
	const int stride, 
	std::vector<KeyPoint>& keypoints, 
	uint64_t* const __restrict descriptors)
{
